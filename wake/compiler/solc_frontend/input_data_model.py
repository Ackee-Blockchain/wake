...
class SolcOutputSelectionEnum(StrEnum):
    ...
    EVM_BYTECODE_ETHDEBUG = "evm.bytecode.ethdebug"
    """Experimental Ethdebug program for creation bytecode"""
    ...
    EVM_DEPLOYED_BYTECODE_ETHDEBUG = "evm.deployedBytecode.ethdebug"
    """Experimental Ethdebug program for deployed bytecode"""
    ...
    YUL_CFG_JSON = "yulCFGJson"
    """Experimental control-flow graph of the SSA-form Yul code"""
    ETHDEBUG_RESOURCES = "ethdebug.resources"
    """Experimental global Ethdebug resources output"""
    ETHDEBUG_COMPILATION = "ethdebug.compilation"
    """Experimental global Ethdebug compilation output"""
    EWASM_ALL = "ewasm"
    """All EWASM subassets"""
...
class SolcInputDebugInfoSettingsEnum(StrEnum):
    ...
    * `<end>` is the index of the first byte after that location.
    ...
    AST_ID = "ast-id"
    """Annotations of the form `@ast-id <id>` for elements mapped to definitions in the Solidity AST."""
    ETHDEBUG = "ethdebug"
    """Experimental Ethdebug annotations."""
