...
from woke.ir.types import Function
...
from woke.ir.ast import SolcFunctionTypeName
from woke.ir.enums import StateMutability, Visibility
...
class FunctionTypeName(TypeNameAbc):
    ...
    !!! example
        ...
        - inside a [VariableDeclaration][woke.ir.declarations.variable_declaration.VariableDeclaration] (lines 1 and 8),
        - inside a [UsingForDirective][woke.ir.meta.using_for_directive.UsingForDirective] (line 5),
        - inside a [ArrayTypeName][woke.ir.type_names.array_type_name.ArrayTypeName] (line 9),
        - inside a [Mapping][woke.ir.type_names.mapping.Mapping] (line 11).
