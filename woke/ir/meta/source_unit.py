...
class SourceUnit(SolidityAbc):
    ...
    !!! warning
        Source unit [byte_location][woke.ir.abc.IrAbc.byte_location] does not cover the whole file.
    ...
    def file_source(self) -> bytes:
        """
        As opposed to [source][woke.ir.abc.IrAbc.source], this property returns the whole file source.
        Returns:
