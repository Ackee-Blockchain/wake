...
class UsingForDirective(SolidityAbc):
    """
    !!! note
        Either [library_name][woke.ir.meta.using_for_directive.UsingForDirective.library_name] must be set or one of [functions][woke.ir.meta.using_for_directive.UsingForDirective.functions] or [operator_functions][woke.ir.meta.using_for_directive.UsingForDirective.operator_functions] must be non-empty.
    !!! example
