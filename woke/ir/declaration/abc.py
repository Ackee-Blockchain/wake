...
class DeclarationAbc(SolidityAbc, ABC):
    ...
    def canonical_name(self) -> str:
        """
        !!! example
            `ContractName.StructName.FieldName` in the case of the `FieldName` [VariableDeclaration][woke.ir.declaration.variable_declaration.VariableDeclaration] declaration in the following example:
            ```solidity
    ...
    def declaration_string(self) -> str:
        ...
        !!! example
            `:::solidity function foo(uint a, uint b) public payable virtual onlyOwner returns (uint)` of the [FunctionDefinition][woke.ir.declaration.function_definition.FunctionDefinition] declaration in the following example:
            ```solidity
