...
from woke.ir.declaration.error_definition import ErrorDefinition
from woke.ir.declaration.event_definition import EventDefinition
from woke.ir.declaration.function_definition import FunctionDefinition
from woke.ir.declaration.modifier_definition import ModifierDefinition
...
from woke.ir.declaration.variable_declaration import VariableDeclaration
...
class ContractDefinition(DeclarationAbc):
    """
    Definition of a contract, library or interface. [byte_location][woke.ir.abc.IrAbc.byte_location] also includes the contract body.
    ...
    def abstract(self) -> bool:
        """
        Is `False` if the [kind][woke.ir.declaration.contract_definition.ContractDefinition.kind] is [ContractKind.LIBRARY][woke.ir.enums.ContractKind.LIBRARY] or [ContractKind.INTERFACE][woke.ir.enums.ContractKind.INTERFACE].
    ...
    def child_contracts(self) -> FrozenSet[ContractDefinition]:
        """
        Returns:
            Contracts that list this contract in their [base_contracts][woke.ir.declaration.contract_definition.ContractDefinition.base_contracts] property.
        """
