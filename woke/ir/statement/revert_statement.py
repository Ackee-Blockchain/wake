...
from woke.ir.ast import SolcRevertStatement
from woke.ir.enums import ModifiesStateFlag
from woke.ir.expression.function_call import FunctionCall
...
class RevertStatement(StatementAbc):
    ...
    !!! warning
        ...
        ```
        This is an [ExpressionStatement][woke.ir.statement.expression_statement.ExpressionStatement] with a [FunctionCall][woke.ir.expression.function_call.FunctionCall] expression:
        ```solidity
