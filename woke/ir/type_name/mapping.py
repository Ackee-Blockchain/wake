...
class Mapping(TypeNameAbc):
    ...
    def key_type(self) -> Union[ElementaryTypeName, UserDefinedTypeName]:
        ...
        - an [ElementaryTypeName][woke.ir.type_name.elementary_type_name.ElementaryTypeName],
        - a [UserDefinedTypeName][woke.ir.type_name.user_defined_type_name.UserDefinedTypeName] of a [Contract][woke.ir.types.Contract] type,
        - a [UserDefinedTypeName][woke.ir.type_name.user_defined_type_name.UserDefinedTypeName] of an [Enum][woke.ir.types.Enum] type,
        - a [UserDefinedTypeName][woke.ir.type_name.user_defined_type_name.UserDefinedTypeName] of a [UserDefinedValueType][woke.ir.types.UserDefinedValueType] type.
        Returns:
