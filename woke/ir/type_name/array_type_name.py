...
class ArrayTypeName(TypeNameAbc):
    ...
    def base_type(self) -> TypeNameAbc:
        """
        !!! example
            `uint8[2]` has `uint8` ([ElementaryTypeName][woke.ir.type_name.elementary_type_name.ElementaryTypeName]) as a base type.

            `uint8[2][3]` has `uint8[2]` ([ArrayTypeName][woke.ir.type_name.array_type_name.ArrayTypeName]) as a base type.
        Returns:
