...
class ElementaryTypeName(TypeNameAbc):
    ...
    !!! example
        ...
        - inside a [VariableDeclaration][woke.ir.declaration.variable_declaration.VariableDeclaration]:
        ...
        - inside a [UserDefinedValueTypeDefinition][woke.ir.declaration.user_defined_value_type_definition.UserDefinedValueTypeDefinition]:
            - `:::solidity int` in line 7,
        - inside an [ElementaryTypeNameExpression][woke.ir.expression.elementary_type_name_expression.ElementaryTypeNameExpression]:
            - `:::solidity int` in line 2,
        - inside a [NewExpression][woke.ir.expression.new_expression.NewExpression]:
        ...
        - inside an [ArrayTypeName][woke.ir.type_name.array_type_name.ArrayTypeName]:
            - `:::solidity uint` in line 11,
        - inside a [Mapping][woke.ir.type_name.mapping.Mapping]:
    ...
    def __init__(
        ...
        from woke.ir.expression.elementary_type_name_expression import (
            ElementaryTypeNameExpression,
        )
    ...
    def parent(
        ...
        """
        When the parent is a [NewExpression][woke.ir.expression.new_expression.NewExpression], this can only be `bytes` or `string`.
        Returns:
            Parent IR node.
        """
        return self._parent
    ...
    def name(self) -> str:
        ...
        !!! tip
            Instead of working with the name, it may be better to use the [type][woke.ir.type_name.elementary_type_name.ElementaryTypeName.type] property.
        Returns:
