...
class RevertStatement(StatementAbc):
    ...
    !!! warning
        ...
        ```
        This is an [ExpressionStatement][woke.ir.statements.expression_statement.ExpressionStatement] with a [FunctionCall][woke.ir.expressions.function_call.FunctionCall] expression:
        ```solidity
