...
class VariableDeclarationStatement(StatementAbc):
    ...
    def initial_value(self) -> Optional[ExpressionAbc]:
        """
        Does not need to be a [TupleExpression][woke.ir.expressions.tuple_expression.TupleExpression] when there is more than one variable declared.
        Can also be a [FunctionCall][woke.ir.expressions.function_call.FunctionCall] returning a tuple.
        Returns:
