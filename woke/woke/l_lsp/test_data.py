...
class TestClass:
    ...
    init_params = (InitializeParams(
        process_id = 1, root_uri = "foo://uri/here/folder/",
    ...
    '''
    did_change_params = (DidChangeTextDocumentParams(
    ...
    init_msg_no_params              =   f'{{"jsonrpc": "2.0","id": 1,"method": "initialize","params":}}'
    # did open
    ...
    did_change_msg_no_params          =   f'{{"jsonrpc": "2.0","method": "textDocument/didChange"}}'
    # exit
