...
class RequestMethodEnum(StrEnum):
    ...
    WORKSPACE_DID_CHANGE_WORKSPACE_FOLDERS = 'workspace/didChangeWorkspaceFolders' # Notification
    WORKSPACE_DID_CHANGE_CONFIGURATION = 'workspace/didChangeConfiguration' # Notification
    WORKSPACE_CONFIGURATION = 'workspace/configuration'
    WORKSPACE_DID_CHANGE_WATCHED_FILES = 'workspace/didChangeWatchedFiles' # Notification
